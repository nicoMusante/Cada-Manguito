    ...
    <div className="px-5 lg:px-0 pt-8 lg:pt-0 flex items-center justify-between">
      {title ? (
        ...
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 lg:w-12 lg:h-12 rounded-full flex items-center justify-center text-white font-semibold lg:text-lg" style={{ backgroundColor: t.avatarBg }}>N</div>
          <div>
