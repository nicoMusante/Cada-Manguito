    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-5">
          <p className="text-[15px] font-semibold" style={{ color: t.textPrimary }}>Nuevo gasto fijo</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <div className="w-24">
              <label className="text-[11px] uppercase tracking-wide" style={{ color: t.textSecondary }}>Día del mes</label>
              <input
                value={diaMes}
