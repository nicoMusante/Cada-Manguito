...
BEGIN
    ...
    INSERT INTO gastos_fijos (usuario_id, categoria_id, descripcion, monto, dia_mes)
    VALUES (p_usuario_id, p_categoria_id, p_descripcion, p_monto, p_dia_mes)
...
BEGIN
    ...
    SELECT monto, estado INTO v_monto_total, v_estado FROM deudas WHERE id = p_deuda_id AND usuario_id = p_usuario_id;
    IF NOT FOUND THEN
        RAISE EXCEPTION 'El movimiento indicado no existe.';
    END IF;
